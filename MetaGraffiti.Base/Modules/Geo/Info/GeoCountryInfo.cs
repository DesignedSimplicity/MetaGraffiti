		...
		*/
		...
		private static void Initialize()
		{
			lock (_cache)
			{
				...
				_cache.Add(new GeoCountryData(GeoContinents.Africa, 654, 2, "SH", "SHN", "", "Saint Helena", "Saint Helena; Ascension and Tristan da Cunha", "", "", "SHN", "St Helena", "St Helena", -15.9650104, -5.7089241, -15.8971900, -5.7920520, -16.0203149, -5.6387530));
