	...
	public class GeoRegionInfo
	{
		...
		private static void Initialize()
		{
			lock (_cache)
			{
				...
				#region Argentina
				_cache.Add(new GeoRegionData(32, 2001, 1, "AR-A", "A", "Salta", @"", -24.7997688, -65.4150367, -21.998386, -68.5469763, -26.3878331, -62.3441087));
				_cache.Add(new GeoRegionData(32, 2002, 1, "AR-B", "B", "Buenos Aires", @"", -37.2017285, -59.8410697, -33.263335, -63.3926469, -41.0404548, -56.6647663));
				...
				_cache.Add(new GeoRegionData(32, 2004, 1, "AR-D", "D", "San Luis", @"", -33.2962042, -66.3294948, -31.862938, -67.3872644, -35.9941063, -64.8808183));
				_cache.Add(new GeoRegionData(32, 2005, 1, "AR-E", "E", "Entre Ríos", @"", -32.517564, -59.104175, -30.157686, -60.768061, -34.039127, -57.811914));
				_cache.Add(new GeoRegionData(32, 2006, 1, "AR-F", "F", "La Rioja", @"", -29.4193793, -66.8559932, -27.7056245, -69.5942521, -31.9974404, -65.4134405));
				_cache.Add(new GeoRegionData(32, 2007, 1, "AR-G", "G", "Santiago del Estero", @"", -27.7910388, -64.2734424, -25.6466647, -65.1891938, -30.4738496, -61.710805));
				_cache.Add(new GeoRegionData(32, 2008, 1, "AR-H", "H", "Chaco", @"", -26.585765, -60.954007, -24.087868, -63.427358, -27.995535, -58.363626));
				_cache.Add(new GeoRegionData(32, 2009, 1, "AR-J", "J", "San Juan", @"", -31.5287127, -68.5360403, -28.36589, -70.5678591, -32.6268692, -66.7151436));
				_cache.Add(new GeoRegionData(32, 2010, 1, "AR-K", "K", "Catamarca", @"", -28.4715877, -65.7877209, -25.154159, -69.0860158, -30.1172541, -64.8243495));
				_cache.Add(new GeoRegionData(32, 2011, 1, "AR-L", "L", "La Pampa", @"", -37.895659, -65.095779, -34.992315, -68.295450, -39.316145, -63.386824));
				_cache.Add(new GeoRegionData(32, 2012, 1, "AR-M", "M", "Mendoza", @"", -32.8896247, -68.8526867, -31.9628078, -70.5746359, -37.5789663, -66.5019948));
				_cache.Add(new GeoRegionData(32, 2013, 1, "AR-N", "N", "Misiones", @"", -26.937714, -54.434213, -25.495489, -56.059504, -28.163359, -53.638557));
				_cache.Add(new GeoRegionData(32, 2014, 1, "AR-P", "P", "Formosa", @"", -26.1894804, -58.2242806, -22.4580218, -62.3473138, -26.8712091, -57.5575981));
				_cache.Add(new GeoRegionData(32, 2015, 1, "AR-Q", "Q", "Neuquén", @"", -38.94587, -68.0730925, -36.0943859, -71.9615579, -41.0915772, -68.0005097));
				_cache.Add(new GeoRegionData(32, 2016, 1, "AR-R", "R", "Río Negro", @"", -40.734434, -66.617645, -37.572914, -71.902907, -42.002498, -62.791082));
				_cache.Add(new GeoRegionData(32, 2017, 1, "AR-S", "S", "Santa Fe", @"", -31.5855109, -60.7238016, -27.9891993, -62.9360244, -34.4156647, -58.8440059));
				_cache.Add(new GeoRegionData(32, 2018, 1, "AR-T", "T", "Tucumán", @"", -26.8221127, -65.2192903, -26.0584289, -66.1620883, -27.9971035, -64.4780028));
				_cache.Add(new GeoRegionData(32, 2019, 1, "AR-U", "U", "Chubut", @"", -43.684619, -69.274553, -41.991621, -72.197338, -46.002230, -63.583257));
				_cache.Add(new GeoRegionData(32, 2020, 1, "AR-V", "V", "Tierra del Fuego", @"", -54.8053998, -68.3242061, -52.658766, -68.6118639, -55.0577157, -65.1153831));
				_cache.Add(new GeoRegionData(32, 2021, 1, "AR-W", "W", "Corrientes", @"", -27.5048498, -58.7804337, -27.2482801, -59.7119606, -30.7213299, -55.6186518));
				_cache.Add(new GeoRegionData(32, 2022, 1, "AR-X", "X", "Córdoba", @"", -31.4200833, -64.1887761, -31.3063946, -64.3195887, -31.4924454, -64.0690993));
				_cache.Add(new GeoRegionData(32, 2023, 1, "AR-Y", "Y", "Jujuy", @"", -24.1843397, -65.302177, -21.7794585, -67.2374206, -24.6074314, -64.1549213));
				_cache.Add(new GeoRegionData(32, 2024, 1, "AR-Z", "Z", "Santa Cruz", @"", -51.6352821, -69.2474353, -45.9915403, -73.5948315, -52.3967385, -65.7171603));
				#endregion
				...
				_cache.Add(new GeoRegionData(152, 2061, 1, "CL-LL", "LL", "Los Lagos", @"", -41.9197779, -72.1416132, -40.2364883, -74.8511988, -44.0668097, -71.5806712));
				...
				_cache.Add(new GeoRegionData(152, 2064, 1, "CL-ML", "ML", "Maule", @"", -35.5163603, -71.5723953, -34.7119046, -72.7858159, -36.5456537, -70.3260117));
				...
				*/
				...
				#region New Zealand
				_cache.Add(new GeoRegionData(554, 2745, 1, "NZ-AUK", "AUK", "Auckland", @"", -36.7422814, 174.5222189, -35.8970151, 174.1525421, -37.2771059, 175.5432281));
				...
				_cache.Add(new GeoRegionData(554, 2747, 1, "NZ-CAN", "CAN", "Canterbury", @"", -43.7542275, 171.1637245, -41.9145239, 169.5585099, -45.088487, 174.0738221));
				_cache.Add(new GeoRegionData(554, 2748, 1, "NZ-GIS", "GIS", "Gisborne", @"", -38.4624528, 177.697554, -37.5329129, 177.1507969, -38.96479, 178.553558));
				_cache.Add(new GeoRegionData(554, 2749, 1, "NZ-HKB", "HKB", "Hawke's Bay", @"", -39.1089867, 176.7416374, -38.580999, 176.0610469, -40.429153, 178.0065001));
				...
				_cache.Add(new GeoRegionData(554, 2751, 1, "NZ-MWT", "MWT", "Manawatu-Wanganui", @"", -39.7273356, 175.4375574, -38.4711149, 174.697216, -40.77409, 176.6308589));
				_cache.Add(new GeoRegionData(554, 2752, 1, "NZ-NSN", "NSN", "Nelson", @"", -41.270631, 173.283965, -40.489841, 171.669662, -41.997321, 174.421738));
				_cache.Add(new GeoRegionData(554, 2753, 1, "NZ-NTL", "NTL", "Northland", @"", -35.5795461, 173.7624053, -34.1355209, 172.112839, -36.3972319, 174.779083));
				_cache.Add(new GeoRegionData(554, 2754, 1, "NZ-OTA", "OTA", "Otago", @"", -45.4790671, 170.1547567, -43.9501939, 168.131563, -46.6558271, 171.1429051));
				_cache.Add(new GeoRegionData(554, 2755, 1, "NZ-STL", "STL", "Southland", @"", -45.9295022, 168.4378583, -44.2552749, 166.4197241, -48.0195079, 169.256336));
				_cache.Add(new GeoRegionData(554, 2756, 1, "NZ-TAS", "TAS", "Tasman", @"", -41.2122123, 172.7347142, -40.4980299, 172.093419, -42.3055977, 173.2318855));
				_cache.Add(new GeoRegionData(554, 2757, 1, "NZ-TKI", "TKI", "Taranaki", @"", -39.3538149, 174.4382721, -38.699306, 173.748474, -39.8687169, 175.002215));
				_cache.Add(new GeoRegionData(554, 2758, 1, "NZ-WGN", "WGN", "Wellington", @"", -41.0299323, 175.4375574, -40.661197, 174.6116179, -41.617874, 176.3376158));
				...
				_cache.Add(new GeoRegionData(554, 2760, 1, "NZ-WTC", "WTC", "West Coast", @"", -42.6919232, 171.3399414, -40.7732929, 168.047775, -44.5080739, 172.699276));
				#endregion
