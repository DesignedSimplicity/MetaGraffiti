...
{
	public class DemoViewModel : AdminViewModel
	{
		// ==================================================
		// Required
		...
		public static string GetCountryUrl(GeoCountryInfo country, string placeType) { return $"/carto/country/{country.Name}/?PlaceType={placeType}"; }
